...
export default function Head() {
  return (
    <div className="my-32 gap-y-26 flex-col flex">
      ...
      <div className="absolute bottom-1/6 left-2/12 bg-radial rounded-full from-yellow-900 from-0% to-dark to-70% size-96 z-0 opacity-65" />
    </div>
  );
}
